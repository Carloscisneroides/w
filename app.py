...
print("Cargando modelo tiny... (puede tardar un momento)")
...
<body>
  <div class="card">
    ...
    <p class="subtitle">Modelo: <strong>tiny</strong> &mdash; Transcripción automática en español</p>
  ...
  <script>
    ...
    transcribeBtn.addEventListener('click', async () => {
      ...
      statusEl.innerHTML = '<span class="spinner"></span>Transcribiendo con modelo tiny...';
